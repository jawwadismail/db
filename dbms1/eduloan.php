...
function closeNav() {
  ...
  <div>
    <h1>Education Loan Eligibility Check</h1>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="Number" class="form-control" placeholder="Example : 20/21/etc" name="text1">
  </div>
...
<div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="Number" class="form-control" placeholder="Enter The Amount" name="text4">
  </div>



  <div class="form-group">
    <label><h5  class="labelclass">Qualification</h5></label>
    <input type="text" class="form-control" placeholder="Pursuing Graduate/Post Graduate/Other" name="text5">
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1"><h5 class="labelclass">SSC Percentage</h5></label>
    <input type="Number" class="form-control" id="exampleInputPassword1" placeholder="Example : 60%/80%/etc" name="text6">
  </div>
  ...
  <div class="form-group">
    ...
    <div><input type="submit" value="submit" name="submit" class="btn btn-success" style="margin-left: 20px;width: 200px;"></input></div>
