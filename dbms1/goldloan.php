...
function closeNav() {
  ...
  <div>
    <h1>Gold Loan Eligibility Check</h1>
  </div>
  <div class="details">
...
<div class="form-group">
   ...
   <div class="form-group">
    <label for="exampleInputPassword1"><h5  class="labelclass">Gold In Grams</h5></label>
    <input type="Number" class="form-control" id="exampleInputPassword1" placeholder="Enter The Weight in grams" name="text3">
  </div>
      </div>
  ...
  <div class="form-group">
    <label><h5  class="labelclass">Purity In Carat</h5></label>
    <input type="Number" class="form-control" placeholder="Example : 18 carat/etc" name="text5">
  </div>
