...
function closeNav() {
  ...
  <div>
    <h1>Personal Loan Eligibility Check</h1>
  </div>
  ...
  <div class="bg">
      <form action="personalloan1.php" method="post">
      <div class="loandetails">
        <div class="form-group">
    <label><h5 class="labelclass">Nationality</h5></label>
    <input type="text" class="form-control" placeholder="Nationality" name="text" required="">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="Number" class="form-control" placeholder="Enter Your Preferred Interest Rate" name="text1" required="">
  </div>

<div class="form-group">
    <label><h5  class="labelclass">Tenure</h5></label>
    <input type="Number" class="form-control" placeholder="Enter Loan Period" name="text2" required="">
  </div>

   <div class="form-group">
    <label for="exampleInputPassword1"><h5  class="labelclass">Age</h5></label>
    <input type="Number" class="form-control" id="exampleInputPassword1" placeholder="Enter Your Age" name="text3" required="">
  </div>
      </div>
    ...
    <input type="Number" class="form-control" placeholder="Enter Loan Amount" name="text4" required="">
  </div>



  <div class="form-group">
    <label><h5  class="labelclass">Year Of Experience</h5></label>
    <input type="Number" class="form-control" placeholder="Experience" name="text5" required="">
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1"><h5 class="labelclass">Monthly Salary</h5></label>
    <input type="Number" class="form-control" id="exampleInputPassword1" placeholder="Enter Salary" name="text6" required="">
  </div>

  <div class="form-group">
    <label><h5 class="labelclass">Year Of Recedance At Current Place</h5></label>
    <input type="Number" class="form-control" placeholder="Example : 1/2/etc" name="text7" required="">
  </div>
      </div>
