...
$query = mysqli_query($con,"SELECT * FROM car WHERE nationality='$name0' and loan_amount >= $name1 and tenure >= $name2 and $name4 >= min_age and $name4 <= max_age and annual_income <=$name3 and interest_rate <=$name5 and cont_emp_year <= $name6 ") or die( mysqli_error($db)); 
